...
const types = [
  ...
  ["/mohammadrezatorkaman.blog.blog.MsgDeleteComment", MsgDeleteComment],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgDeleteComment: (data: MsgDeleteComment): EncodeObject => ({ typeUrl: "/mohammadrezatorkaman.blog.blog.MsgDeleteComment", value: MsgDeleteComment.fromPartial( data ) }),
